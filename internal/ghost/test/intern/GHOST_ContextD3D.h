...
struct GHOST_ContextD3D : public GHOST_Context {
  ...
  struct GHOST_SharedOpenGLResource *createSharedOpenGLResource(
      unsigned int width,
      unsigned int height,
      DXGI_FORMAT format,
      ID3D11RenderTargetView *render_target);
  struct GHOST_SharedOpenGLResource *createSharedOpenGLResource(unsigned int width,
                                                               unsigned int height,
                                                               DXGI_FORMAT format);
