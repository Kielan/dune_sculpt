...
static void basic_draw_scene(void *vedata)
{
  ...
  draw_draw_pass(psl->depth_pass[0]);
  draw_draw_pass(psl->depth_pass_pointcloud[0]);
  draw_draw_pass(psl->depth_pass_cull[0]);
  draw_draw_pass(psl->depth_pass[1]);
  draw_draw_pass(psl->depth_pass_pointcloud[1]);
  draw_draw_pass(psl->depth_pass_cull[1]);
}
