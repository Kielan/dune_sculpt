...
#define BUF_LINE(grp, format) draw_shgroup_call_buffer(grp, format, GPU_PRIM_LINES)
    ...
    /* Sorted by shader to avoid state changes during render. */
    {
      ...
      cb->camera_distances = BUF_INSTANCE(grp_sub, format, draw_cache_camera_distances_get());
      cb->camera_frame = BUF_INSTANCE(grp_sub, format, draw_cache_camera_frame_get());
      cb->camera_tria[0] = BUF_INSTANCE(grp_sub, format, draw_cache_camera_tria_wire_get());
      cb->camera_tria[1] = BUF_INSTANCE(grp_sub, format, draw_cache_camera_tria_get());
      cb->empty_axes = BUF_INSTANCE(grp_sub, format, draw_cache_bone_arrows_get());
      cb->empty_capsule_body = BUF_INSTANCE(grp_sub, format, draw_cache_empty_capsule_body_get());
      cb->empty_capsule_cap = BUF_INSTANCE(grp_sub, format, draw_cache_empty_capsule_cap_get());
      cb->empty_circle = BUF_INSTANCE(grp_sub, format, draw_cache_circle_get());
      cb->empty_cone = BUF_INSTANCE(grp_sub, format, draw_cache_empty_cone_get());
      cb->empty_cube = BUF_INSTANCE(grp_sub, format, draw_cache_empty_cube_get());
      cb->empty_cylinder = BUF_INSTANCE(grp_sub, format, draw_cache_empty_cylinder_get());
      cb->empty_image_frame = BUF_INSTANCE(grp_sub, format, draw_cache_quad_wires_get());
      cb->empty_plain_axes = BUF_INSTANCE(grp_sub, format, draw_cache_plain_axes_get());
      cb->empty_single_arrow = BUF_INSTANCE(grp_sub, format, draw_cache_single_arrow_get());
      cb->empty_sphere = BUF_INSTANCE(grp_sub, format, draw_cache_empty_sphere_get());
      cb->empty_sphere_solid = BUF_INSTANCE(grp_sub, format, draw_cache_sphere_get(DRAW_LOD_LOW));
      cb->field_cone_limit = BUF_INSTANCE(grp_sub, format, draw_cache_field_cone_limit_get());
      cb->field_curve = BUF_INSTANCE(grp_sub, format, draw_cache_field_curve_get());
      cb->field_force = BUF_INSTANCE(grp_sub, format, draw_cache_field_force_get());
      cb->field_sphere_limit = BUF_INSTANCE(grp_sub, format, draw_cache_field_sphere_limit_get());
      cb->field_tube_limit = BUF_INSTANCE(grp_sub, format, draw_cache_field_tube_limit_get());
      cb->field_vortex = BUF_INSTANCE(grp_sub, format, draw_cache_field_vortex_get());
      cb->field_wind = BUF_INSTANCE(grp_sub, format, draw_cache_field_wind_get());
      cb->light_area[0] = BUF_INSTANCE(grp_sub, format, draw_cache_light_area_disk_lines_get());
      cb->light_area[1] = BUF_INSTANCE(grp_sub, format, draw_cache_light_area_square_lines_get());
      cb->light_point = BUF_INSTANCE(grp_sub, format, draw_cache_light_point_lines_get());
      cb->light_spot = BUF_INSTANCE(grp_sub, format, draw_cache_light_spot_lines_get());
      cb->light_sun = BUF_INSTANCE(grp_sub, format, draw_cache_light_sun_lines_get());
