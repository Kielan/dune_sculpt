...
#include "dpen_engine.h"

extern char datatoc_dpen_common_lib_glsl[];
extern char datatoc_dpen_frag_glsl[];
extern char datatoc_dpen_vert_glsl[];
extern char datatoc_dpen_antialiasing_frag_glsl[];
extern char datatoc_dpen_antialiasing_vert_glsl[];
extern char datatoc_dpen_layer_blend_frag_glsl[];
extern char datatoc_dpen_mask_invert_frag_glsl[];
extern char datatoc_dpen_depth_merge_frag_glsl[];
extern char datatoc_dpen_depth_merge_vert_glsl[];
extern char datatoc_dpen_vfx_frag_glsl[];
...
GPUShader *dpen_shader_antialiasing(int stage)
{
  lib_assert(stage < 3);
...
GPUShader *dpen_shader_geometry_get(void)
{
  if (!g_shaders.dpen_sh) {
    g_shaders.gpencil_sh = GPU_shader_create_from_info_name("gpencil_geometry");
  }
  return g_shaders.gpencil_sh;
}

GPUShader *dpen_shader_layer_blend_get(void)
{
...
GPUShader *dpen_shader_mask_invert_get(void)
{
...
GPUShader *dpen_shader_depth_merge_get(void)
{
...
GPUShader *dpen_shader_fx_blur_get(void)
{
...
GPUShader *dpen_shader_fx_colorize_get(void)
{
...
GPUShader *dpen_shader_fx_composite_get(void)
{
...
GPUShader *dpen_shader_fx_glow_get(void)
{
...
GPUShader *dpen_shader_fx_pixelize_get(void)
{
...
GPUShader *dpen_shader_fx_rim_get(void)
{
...
GPUShader *dpen_shader_fx_shadow_get(void)
{
...
GPUShader *dpen_shader_fx_transform_get(void)
{
