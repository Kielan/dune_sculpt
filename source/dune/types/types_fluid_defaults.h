...
/* Fluid Domain Settings Struct */

#define _TYPES_DEFAULT_FluidDomainSettings \
  { \
    .fmd = NULL, \
    .fluid = NULL, \
    .fluid_old = NULL, \
    ...
    .guide_parent = NULL, \
    .effector_weights = NULL, /* dune_effector_add_weights. */ \
    .p0 = {0.0f, 0.0f, 0.0f}, \
    .p1 = {0.0f, 0.0f, 0.0f}, \
    .dp0 = {0.0f, 0.0f, 0.0f}, \
    ...
    .imat = _TYPES_DEFAULT_UNIT_M4, \
    .obmat = _TYPES_DEFAULT_UNIT_M4, \
    .fluidmat = _TYPES_DEFAULT_UNIT_M4, \
    .fluidmat_wt = _TYPES_DEFAULT_UNIT_M4, \
    .base_res = {0, 0, 0}, \
    .res_min = {0, 0, 0}, \
    .res_max = {0, 0, 0}, \
    .res = {0, 0, 0}, \
...
/* Fluid Flow Settings Struct */

#define _TYPES_DEFAULT_FluidFlowSettings \
  { \
    .fmd = NULL, \
    .mesh = NULL, \
    .psys = NULL, \
...
/* Fluid Effector Settings Struct */
#define _TYPES_DEFAULT_FluidEffectorSettings \
  { \
    .fmd = NULL, \
    .mesh = NULL, \
    .verts_old = NULL, \
