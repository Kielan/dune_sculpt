 ...
 *   - dune_ptcache_data_size()
 *   - ptcache_file_ptrs_init() */
#define DPHYS_DATA_INDEX 0
#define DPHYS_DATA_LOCATION 1
#define DPHYS_DATA_SMOKE_LOW 1
#define DPHYS_DATA_VELOCITY 2
#define DPHYS_DATA_SMOKE_HIGH 2
#define DPHYS_DATA_ROTATION 3
#define DPHYS_DATA_DYNAMICPAINT 3
#define DPHYS_DATA_AVELOCITY 4 /* used for particles */
#define DPHYS_DATA_XCONST 4    /* used for cloth */
#define DPHYS_DATA_SIZE 5
#define DPHYS_DATA_TIMES 6
#define DPHYS_DATA_BOIDS 7

#define DPHYS_TOT_DATA 8

#define DPHYS_EXTRA_FLUID_SPRINGS 1
#define DPHYS_EXTRA_CLOTH_ACCELERATION 2
