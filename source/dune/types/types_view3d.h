...
#define V3D_PEN_SHOW_ONION_SKIN (1 << 4)       /* main switch at view level */
#define V3D_PEN_FADE_NOACTIVE_LAYERS (1 << 5)  /* fade layers not active */
#define V3D_PEN_FADE_NOACTIVE_PEN (1 << 6) /* Fade other GPencil objects */
#define V3D_PEN_SHOW_STROKE_DIRECTION (1 << 7) /* Show Strokes Directions */
