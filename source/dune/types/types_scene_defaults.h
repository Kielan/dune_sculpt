...
#include "types_view3d_defaults.h"
...
#define _TYPES_DEFAULT_ImageFormatData \
  { \
...
#define _TYPES_DEFAULT_BakeData \
  { \
    .im_format = _TYPES_DEFAULT_ImageFormatData, \
    .filepath = "//", \
    .flag = R_BAKE_CLEAR, \
...
#define _TYPES_DEFAULT_FFMpegCodecData \
  { \
    .audio_mixrate = 48000, \
    .audio_volume = 1.0f, \
    .audio_bitrate = 192, \
...
#define _TYPES_DEFAULT_DisplaySafeAreas \
  { \
...
#define _TYPES_DEFAULT_RenderData \
  { \
    .mode = 0, \
    .cfra = 1, \
    .sfra = 1, \
 ...
 \
    .ffcodecdata = _TYPES_DEFAULT_FFMpegCodecData, \
  }
...
#define _TYPES_DEFAULT_Scene \
  { \
    .cursor = _TYPES_DEFAULT_View3DCursor, \
    .r = _TYPES_DEFAULT_RenderData, \
    .audio = _TYPES_DEFAULT_AudioData, \
 \
    .display = _TYPES_DEFAULT_SceneDisplay, \
 \
    .physics_settings = _TYPES_DEFAULT_PhysSettings, \
 \
    .safe_areas = _TYPES_DEFAULT_DisplaySafeAreas, \
 \
    .eevee = _TYPES_DEFAULT_SceneEEVEE, \
  }
...
#define _TYPES_DEFAULTS_CurvePaintSettings \
  { \
...
#define _TYPES_DEFAULTS_ImagePaintSettings \
  { \
...
#define _TYPES_DEFAULTS_ParticleBrushData \
  { \
    .strength = 0.5f, \
    .size = 50, \
    .step = 10, \
...
#define _TYPES_DEFAULTS_UnifiedPaintSettings \
  { \
    .size = 50, \
...
#define _TYPES_DEFAULTS_ParticleEditSettings \
  { \
 ...
 \
    ...
    .brush = {_TYPES_DEFAULTS_ParticleBrushData}, \
 \
    .draw_step = 2, \
    .fade_frames = 2, \
...
#define _TYPES_DEFAULTS_PEN_Sculpt_Guide \
  { \
    .spacing = 20.0f, \
  }

#define _TYPES_DEFAULTS_PEN_Sculpt_Settings \
  { \
    .guide = _TYPES_DEFAULTS_PEN_Sculpt_Guide, \
  }

#define _TYPES_DEFAULTS_MeshStatVis \
  { \
...
#define _TYPES_DEFAULT_ToolSettings \
  { \
 ...
 \
    .curve_paint_settings = _TYPES_DEFAULTS_CurvePaintSettings, \
 \
    .unified_paint_settings = _TYPES_DEFAULTS_UnifiedPaintSettings, \
 \
    .statvis = _TYPES_DEFAULTS_MeshStatVis, \
 \
    .proportional_size = 1.0f, \
 \
    .imapaint = _TYPES_DEFAULTS_ImagePaintSettings, \
 \
    .particle = _TYPES_DEFAULTS_ParticleEditSettings, \
 \
    .pen_sculpt = _TYPES_DEFAULTS_PEN_Sculpt_Settings, \
 \
    /* Annotations */ \
    .annotate_v3d_align = PEN_PROJECT_VIEWSPACE | PEN_PROJECT_CURSOR, \
    .annotate_thickness = 3, \
 \
    /* Pen Stroke Placement */ \
    .pen_v3d_align = PEN_PROJECT_VIEWSPACE, \
    .pen_v2d_align = PEN_PROJECT_VIEWSPACE, \
 \
    /* UV painting */ \
