...
typedef struct NodeImageLayer {
  ...
  int pass_index TYPES_DEPRECATED;
  /* render pass name */
...
/* first struct fields should match NodeImageFile to ensure forward compatibility */
typedef struct NodeImageMultiFile {
  /** 1024 = FILE_MAX. */
  char base_path[1024];
  ImageFormatData format;
  /* old frame rand values from NodeImageFile for forward compatibility. */
  int sfra TYPES_DEPRECATED, efra TYPES_DEPRECATED;
...
typedef struct NodeImageMultiFileSocket {
  ...
  short use_render_format TYPES_DEPRECATED;
...
typedef struct NodeGlare {
  ...
  char angle TYPES_DEPRECATED, _pad0, size, star_45, streaks;
...
typedef struct NodeTexImage {
  NodeTexBase base;
  ImageUser iuser;
  int color_space TYPES_DEPRECATED;
  int projection;
...
typedef enum NodeBoolMathOp {
  NODE_BOOL_MATH_AND = 0,
  NODE_BOOL_MATH_OR = 1,
  NODE_BOOL_MATH_NOT = 2,

  NODE_BOOL_MATH_NAND = 3,
  NODE_BOOL_MATH_NOR = 4,
  NODE_BOOL_MATH_XNOR = 5,
  NODE_BOOL_MATH_XOR = 6,

  NODE_BOOL_MATH_IMPLY = 7,
  NODE_BOOL_MATH_NIMPLY = 8,
} NodeBoolMathOp;
...
typedef enum GeometryNodeBoolOp {
  GEO_NODE_BOOL_INTERSECT = 0,
  GEO_NODE_BOOL_UNION = 1,
  GEO_NODE_BOOL_DIFFERENCE = 2,
} GeometryNodeBoolOp;
