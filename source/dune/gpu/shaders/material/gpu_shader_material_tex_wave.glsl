#pragma DUNE_REQUIRE(gpu_shader_common_hash.glsl)
#pragma DUNE_REQUIRE(gpu_shader_material_noise.glsl)
#pragma DUNE_REQUIRE(gpu_shader_material_fractal_noise.glsl)
