...
class MFProcedure : NonCopyable, NonMovable {
 ...
 public:
  ...
  Span<ConstMFParam> params() const;

  template<typename T, typename... Args> const MultiFn &construct_fn(Args &&...args);
...
inline Span<ConstMFParam> MFProcedure::params() const
{
  static_assert(sizeof(MFParameter) == sizeof(ConstMFParam));
  return params_.as_span().cast<ConstMFParam>();
}
