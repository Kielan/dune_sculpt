 ...
 * Node bc otherwise the default vals for the outputs are not known. The lazy-function
 * params do not differentiate between e.g. float and vector sockets. The #SocketValueVariant
...
class NodeAnonymousAttributeId : public dune::AnonymousAttributeId {
  std::string long_name_;
  std::string socket_name_;

 public:
  NodeAnonymousAttributeId(const Ob &ob,
