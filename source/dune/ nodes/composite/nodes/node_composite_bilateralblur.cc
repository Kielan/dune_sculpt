...
namespace dune::nodes::node_composite_bilateralblur_cc {
...
{
  return new BilateralBlurOp(context, node);
}
...
{
  namespace file_ns = dune::nodes::node_composite_bilateralblur_cc;
