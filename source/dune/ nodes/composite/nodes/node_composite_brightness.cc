...
}  // namespace dune::nodes::node_composite_brightness_cc

void register_node_type_cmp_brightcontrast()
{
  namespace file_ns = dune::nodes::node_composite_brightness_cc;
  ...
  ntype.draw_btns = file_ns::node_composit_buts_brightcontrast;
  ntype.initfn = file_ns::node_composit_init_brightcontrast;
