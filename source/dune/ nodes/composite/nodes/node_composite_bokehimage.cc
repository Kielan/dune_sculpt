...
static NodeOp *get_compositor_op(Context &context, DNode node)
{
  return new BokehImageOp(context, node);
}

}  // namespace dune::nodes::node_composite_bokehimage_cc

void register_node_type_cmp_bokehimage()
{
  namespace file_ns = dune::nodes::node_composite_bokehimage_cc;
