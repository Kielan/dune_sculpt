 ...
 * slightly diff storage requirements, but a lot of the logic is still the same between nodes.
 ...
 * how to deal with specific item arrays. Diff fns have diff requirements for the
...
namespace dune::nodes::socket_items {

/* Refs a "C-Array" that is stored elsewhere. This is diff from a MutableSpan bc
 * can resize the arr through this ref. */
