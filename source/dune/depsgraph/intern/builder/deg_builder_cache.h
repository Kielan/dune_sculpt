...
class AnimatedPropertyStorage {
 public:
  ...
  void tagPropertyAsAnimated(const AnimatedPropertyID &prop_id);
  void tagPropertyAsAnimated(const PointerRNA *pointer_rna, const ApiProp *property_rna);
...
class DepsgraphBuilderCache {
 public:
  ...
  AnimatedPropStorage *ensureAnimatedPropertyStorage(ID *id);
  AnimatedPropStorage *ensureInitializedAnimatedPropertyStorage(ID *id);
