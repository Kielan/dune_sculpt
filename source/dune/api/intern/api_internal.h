...
void api_def_main_collections(BlenderRNA *brna, PropertyRNA *cprop);
void api_def_main_texts(BlenderRNA *brna, PropertyRNA *cprop);
void api_def_main_speakers(BlenderRNA *brna, PropertyRNA *cprop);
void api_def_main_sounds(BlenderRNA *brna, PropertyRNA *cprop);
void api_def_main_armatures(BlenderRNA *brna, PropertyRNA *cprop);
void spi_def_main_actions(BlenderRNA *brna, PropertyRNA *cprop);
void api_def_main_particles(BlenderRNA *brna, PropertyRNA *cprop);
void api_def_main_palettes(BlenderRNA *brna, PropertyRNA *cprop);
void api_def_main_gpencil(BlenderRNA *brna, PropertyRNA *cprop);
