...
void api_main(struct ApiStruct *srna);
void api_material(ApiStruct *sapi);
void api_mesh(struct ApiStruct *sapi);
void api_meta(struct ApiStruct *sapi);
void api_object(struct ApiStruct *sapi);
void api_pose(struct ApiStruct *sapi);
void api_pose_channel(struct ApiStruct *sapi);
void api_scene(struct ApiStruct *sapi);
void api_scene_render(struct ApiStruct *sapi);
void api_sequence_strip(ApiStruct *sapi);
void api_text(struct ApiStruct sapi);
void api_ui_layout(struct ApiStruct *sapi);
void api_window(struct ApiStruct *sapi);
...
void api_def_main_images(DuneApi *dapi, ApiProp *cprop);
...
void api_def_main_fonts(DuneApi *dapi, ApiProp *cprop);
void api_def_main_textures(DuneApi *dapi, ApiProp *cprop);
void api_def_main_brushes(DuneApi *dapi, ApiProp *cprop);
void api_def_main_worlds(DuneApi *dapi, ApiProp *cprop);
void api_def_main_collections(DuneApo *dapi, ApiProp *cprop);
void api_def_main_texts(DuneApi *dapi, ApiProp *cprop);
