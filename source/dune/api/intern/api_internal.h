...
/* API functions */
void api_action(StructRNA *srna);
void api_animdata(struct StructRNA *srna);
void api_armature_edit_bone(StructRNA *srna);
void api_bone(StructRNA *srna);
void api_camera(StructRNA *srna);
void api_curve(StructRNA *srna);
void api_curve_nurb(StructRNA *srna);
void api_fcurves(StructRNA *srna);
void api_drivers(StructRNA *srna);
void api_image_packed_file(struct StructRNA *srna);
void api_image(struct StructRNA *srna);
void api_lattice(struct StructRNA *srna);
void api_op(struct StructRNA *srna);
void api_macro(struct StructRNA *srna);
void api_gizmo(struct StructRNA *srna);
void api_gizmogroup(struct StructRNA *srna);
void api_keyconfig(struct StructRNA *srna);
void api_keyconfigs(struct StructRNA *srna);
void api_keyingset(struct StructRNA *srna);
void api_keymap(struct StructRNA *srna);
void api_keymaps(struct StructRNA *srna);
void api_keymapitem(struct StructRNA *srna);
void api_keymapitems(struct StructRNA *srna);
