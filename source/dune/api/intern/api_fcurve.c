...
static void api_def_fmod_generator(DuneApi *dapi)
{
  ...
  api_def_struct_ui_text(
      srna, "Generator F-Mod", "Deterministically generate values for the modified F-Curve");
  ...
  RNA_def_property_update(prop, NC_ANIMATION | ND_KEYFRAME | NA_EDITED, "api_FMod_update");
