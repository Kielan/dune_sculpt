...
const EnumPropItem api_enum_cx_mode_items[] = {
    {CX_MODE_EDIT_MESH, "EDIT_MESH", 0, "Mesh Edit", ""},
    {CX_MODE_EDIT_CURVE, "EDIT_CURVE", 0, "Curve Edit", ""},
    {CX_MODE_EDIT_CURVES, "EDIT_CURVES", 0, "Curves Edit", ""},
    {CX_MODE_EDIT_SURFACE, "EDIT_SURFACE", 0, "Surface Edit", ""},
    {CX_MODE_EDIT_TEXT, "EDIT_TEXT", 0, "Text Edit", ""},
    /* PARSKEL reuse will give issues */
    {CX_MODE_EDIT_ARMATURE, "EDIT_ARMATURE", 0, "Armature Edit", ""},
    {CX_MODE_EDIT_METABALL, "EDIT_METABALL", 0, "Metaball Edit", ""},
    {CX_MODE_EDIT_LATTICE, "EDIT_LATTICE", 0, "Lattice Edit", ""},
    {CX_MODE_POSE, "POSE", 0, "Pose", ""},
    {CX_MODE_SCULPT, "SCULPT", 0, "Sculpt", ""},
    {CX_MODE_PAINT_WEIGHT, "PAINT_WEIGHT", 0, "Weight Paint", ""},
    {CX_MODE_PAINT_VERTEX, "PAINT_VERTEX", 0, "Vertex Paint", ""},
    {CX_MODE_PAINT_TEXTURE, "PAINT_TEXTURE", 0, "Texture Paint", ""},
    {CX_MODE_PARTICLE, "PARTICLE", 0, "Particle", ""},
    {CX_MODE_OBJECT, "OBJECT", 0, "Object", ""},
    {CX_MODE_PAINT_PEN, "PAINT_PEN", 0, "Pen Paint", ""},
    {CX_MODE_EDIT_PEN, "EDIT_PEN", 0, "Pen Edit", ""},
    {CX_MODE_SCULPT_PEN, "SCULPT_PEN", 0, "Pen Sculpt", ""},
    {CX_MODE_WEIGHT_PEN, "WEIGHT_PEN", 0, "Pen Weight Paint", ""},
    {CX_MODE_VERTEX_PEN, "VERTEX_PEN", 0, "Pen Vertex Paint", ""},
    {CX_MODE_SCULPT_CURVES, "SCULPT_CURVES", 0, "Curves Sculpt", ""},
    {0, NULL, 0, NULL, NULL},
};
