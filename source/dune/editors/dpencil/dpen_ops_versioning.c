...
void DPEN_OT_convert_old_files(wmOperatorType *ot)
{
  /* identifiers */
  ...
  /* callbacks */
  ot->exec = gpenc_convert_old_files_exec;
  ot->poll = gpen_convert_old_files_poll;

  /* flags */
  ot->flag = OPTYPE_REGISTER | OPTYPE_UNDO;

  /* props */
  ot->prop = api_def_bool(ot->srna, "annotation", 0, "Annotation", "Convert to Annotations");
}
