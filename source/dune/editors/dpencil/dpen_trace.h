...
/* Trace modes */
#define DPEN_TRACE_MODE_SINGLE 0
#define DPEN_TRACE_MODE_SEQUENCE 1
 ...
 */
void ed_dpen_trace_bitmap_print(FILE *f, const potrace_bitmap_t *bm);
 ...
 * return Trace bitmap
 */
potrace_bitmap_t *ed_dpen_trace_bitmap_new(int32_t w, int32_t h);
/**
 * Free a trace bitmap
 * param bm: Trace bitmap
 */
void ed_dpen_trace_bitmap_free(const potrace_bitmap_t *bm);
/**
 * Invert the given bitmap (Black to White)
 * param bm: Trace bitmap
 */
void ED_dpen_trace_bitmap_invert(const potrace_bitmap_t *bm);
 ...
 * param bm: Trace bitmap
 */
void ed_dpen_trace_image_to_bitmap(struct ImBuf *ibuf,
                                      const potrace_bitmap_t *bm,
                                      float threshold);

/**
 * Convert Potrace Bitmap to Dune Pen strokes
 ...
 */
void ed_dpen_trace_data_to_strokes(struct Main *dmain,
                                      potrace_state_t *st,
                                      struct Object *ob,
