...
void DPEN_OT_bake_pen_animation(wmOperatorType *ot)
{
  ApiProp *prop;

  /* identifiers */
  ot->name = "Bake Object Transform to Dune Pen";
  ot->idname = "DPEN_OT_bake_pen_animation";
  ot->description = "Bake pen object transform to pen keyframes";

  /* callbacks */
  ot->invoke = dpen_bake_pen_animation_invoke;
  ot->exec = dpen_bake_pen_animation_ex;
  ot->poll = dpen_bake_pen_animation_poll;
