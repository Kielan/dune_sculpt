...
static int gpencil_editcurve_set_handle_type_exec(bContext *C, wmOperator *op)
{
  ...
  GP_EDITABLE_CURVES_BEGIN(gps_iter, C, gpl, gps, gpc)
  {
    ...
    dune_dpen_editcurve_recalculate_handles(dps);
    dps->flag |= DPEN_STROKE_NEEDS_CURVE_UPDATE;
    dune_dpen_stroke_geometry_update(dpd, dps);
  }
...
void DPEN_OT_stroke_editcurve_set_handle_type(wmOperatorType *ot)
{
  ...
  ot->idname = "DPEN_OT_stroke_editcurve_set_handle_type";
  ot->description = "Set the type of a edit curve handle";

  /* api callbacks */
  ot->invoke = wm_menu_invoke;
  ot->ex = dpen_editcurve_set_handle_type_ex;
  ot->poll = dpen_curve_edit_mode_poll;
