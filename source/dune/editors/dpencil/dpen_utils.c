...
void ED_gpencil_setup_modes(bContext *C, bGPdata *gpd, int newmode)
{
  ...
  switch (newmode) {
    ...
    case OB_MODE_WEIGHT_GPENCIL:
      ...
      ED_gpencil_toggle_brush_cursor(C, true, NULL);
      break;
    case OB_MODE_VERTEX_DPEN:
      dpd->flag &= ~GP_DATA_STROKE_EDITMODE;
      dpd->flag &= ~GP_DATA_STROKE_PAINTMODE;
      dpd->flag &= ~GP_DATA_STROKE_SCULPTMODE;
      dpd->flag &= ~GP_DATA_STROKE_WEIGHTMODE;
      dpd->flag |= GP_DATA_STROKE_VERTEXMODE;
      ed_dpen_toggle_brush_cursor(C, true, NULL);
      break;
    default:
      dpd->flag &= ~DPEN_DATA_STROKE_EDITMODE;
      dpd->flag &= ~DPEN_DATA_STROKE_PAINTMODE;
      dpd->flag &= ~DPEN_DATA_STROKE_SCULPTMODE;
      dpd->flag &= ~DPEN_DATA_STROKE_WEIGHTMODE;
      dpd->flag &= ~DPEN_DATA_STROKE_VERTEXMODE;
      ed_dpen_toggle_brush_cursor(C, false, NULL);
      break;
  }
}
