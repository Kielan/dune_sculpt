...
static bool edbm_preselect_or_active(DuneContext *C, const View3D *v3d, Base **r_base, BMElem **r_ele)
{
...
static bool edbm_preselect_or_active_init_viewcontext(DuneContext *C,
                                                      ViewContext *vc,
                                                      Base **r_base,
                                                      BMElem **r_ele)
{
...
static int edbm_polybuild_delete_at_cursor_invoke(DuneContext *C,
                                                  wmOperator *op,
                                                  const wmEvent *UNUSED(event))
{
  bool changed = false;
