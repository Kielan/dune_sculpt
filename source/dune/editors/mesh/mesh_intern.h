 ...
 */
bool EDBM_op_call_silentf(struct DuneMeshEdit *em, const char *fmt, ...);
...
bool EDBM_op_init(
    struct DuneMeshEdit *em, struct BMOperator *bmop, struct wmOperator *op, const char *fmt, ...);
 ...
 * - True on success, executes and finishes a DuneMesh operator.
 */
bool EDBM_op_finish(struct DuneMeshEdit *em,
                    struct DuneMeshOperator *bmop,
                    struct wmOperator *op,
                    bool do_report);

void EDBM_stats_update(struct DuneMeshEdit *em);

/**
 * Poll call for mesh operators requiring a view3d context.
 */
bool EDBM_view3d_poll(struct DuneContext *C);

struct DuneMeshElem *EDBM_elem_from_selectmode(struct DuneMeshEdit *em,
 ...
 */
int EDBM_elem_to_index_any(struct DuneMeshEdit *em, struct DuneMeshElem *ele);
struct DuneMeshElem *EDDM_elem_from_index_any(struct DuneMeshEdit *em, uint index);

int EDBM_elem_to_index_any_multi(struct ViewLayer *view_layer,
                                 struct DuneMeshEdit *em,
                                 struct DuneMeshElem *ele,
                                 int *r_object_index);
struct DuneMeshElem *EDBM_elem_from_index_any_multi(struct ViewLayer *view_layer,
                                              uint object_index,
                                              uint elem_index,
                                              struct Object **r_obedit);

/** * Extrudes individual edges. */
bool edbm_extrude_edges_indiv(struct DuneMeshEdit *duneMeshEdit,
                              struct wmOperator *op,
                              char hflag,
 ...
 */
void EDDM_mesh_knife(struct bContext *C,
