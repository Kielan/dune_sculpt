 ...
 *
 * - Index files are created for each blend file in the asset library, even when the dune file
 *   doesn't contain any assets.
 * - Indexes are stored in an persistent cache folder (`dune_appdir_folder_caches` +
 ...
 * - .dune files without any assets can be determined by the size of the index file for some
