...
void ui_GetThemeColorDuneShade3ubv(
    int colorid1, int colorid2, float fac, int offset, uchar col[3])
{
  ...
  float dune[3];
  dune[0] = (offset + floorf((1.0f - fac) * cp1[0] + fac * cp2[0])) / 255.0f;
  dune[1] = (offset + floorf((1.0f - fac) * cp1[1] + fac * cp2[1])) / 255.0f;
  dune[2] = (offset + floorf((1.0f - fac) * cp1[2] + fac * cp2[2])) / 255.0f;
