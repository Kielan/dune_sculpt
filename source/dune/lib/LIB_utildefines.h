/* Use a define instead of `#pragma once` because of `LIB_memory_utils.h` */
#ifndef __LIB_UTILDEFINES_H__
 ...
 */
#define LIB_ENABLE_IF(condition) typename std::enable_if_t<(condition)> * = nullptr
