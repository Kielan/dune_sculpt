 ...
 */
void mesh_decimate_collapse(Mesh *bm,
                               float factor,
                               float *vweights,
...
void mesh_decimate_unsubdivide_ex(BMesh *bm, int iterations, bool tag_only);
void mesh_decimate_unsubdivide(BMesh *bm, int iterations);

void mesh_decimate_dissolve_ex(BMesh *bm,
                                  float angle_limit,
                                  ...
                                  int einput_len,
                                  short oflag_out);
void mesh_decimate_dissolve(BMesh *bm,
                               float angle_limit,
                               bool do_dissolve_boundaries,
