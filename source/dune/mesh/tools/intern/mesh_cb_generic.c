/** Mesh element callback functions. **/
...
bool mesh_elem_cb_check_hflag_ex(MeshElem *ele, void *user_data)
{
...
bool mesh_elem_cb_check_hflag_enabled(MeshElem *ele, void *user_data)
{
...
bool mesh_elem_cb_check_hflag_disabled(MeshElem *ele, void *user_data)
{
  const char hflag = PTR_AS_INT(user_data);
