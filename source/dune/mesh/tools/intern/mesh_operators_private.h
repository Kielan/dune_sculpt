...
void mesh_mirror_exec(Mesh *mesh, MeshOp *op);
void bmo_object_load_mesh_ex(Mesh *m, MeshOp *op);
void bmo_pointmerge_ex(Mesh *m, MeshOp *op);
void bmo_pointmerge_facedata_ex(Mesh *bm, MeshOp *op);
void bmo_recalc_face_normals_ex(Mesh *bm, MeshOp *op);
void bmo_poke_ex(Mesh *mesh, MeshOp *op);
void bmo_offset_edgeloops_ex(Mesh *mesh, MeshOp *op);
void bmo_planar_faces_ex(Mesh *mesh, MeshOp *op);
void bmo_region_extend_ex(Mesh *mesh, MeshOp *op);
void bmo_remove_doubles_ex(Mesh *mesh, MeshOp *op);
void bmo_reverse_colors_ex(Mesh *mesh, MeshOp *op);
void bmo_reverse_faces_ex(Mesh *mesh, MeshOp *op);
void bmo_reverse_uvs_ex(Mesh *mesh, MeshOp *op);
void bmo_rotate_colors_ex(Mesh *mesh, MeshOp *op);
void bmo_rotate_edges_ex(Mesh *mesh, MeshOp *op);
void bmo_rotate_exec(Mesh *mesh, MeshOp *op);
void bmo_rotate_uvs_ex(Mesh *mesh, MeshOp *op);
void bmo_scale_exec(Mesh *mesh, MeshOp *op);
void bmo_smooth_vert_ex(Mesh *bm, BMOp *op);
