...
void bmo_pointmerge_facedata_ex(BMesh *bm, BMOperator *op);
void bmo_recalc_face_normals_ex(BMesh *bm, BMOperator *op);
void bmo_poke_ex(BMesh *bm, BMOperator *op);
void bmo_offset_edgeloops_ex(BMesh *bm, BMOperator *op);
void bmo_planar_faces_ex(BMesh *bm, BMOperator *op);
void bmo_region_extend_ex(BMesh *bm, BMOperator *op);
void bmo_remove_doubles_ex(BMesh *bm, BMOperator *op);
void bmo_reverse_colors_ex(BMesh *bm, BMOperator *op);
void bmo_reverse_faces_ex(BMesh *bm, BMOperator *op);
void bmo_reverse_uvs_ex(BMesh *bm, BMOperator *op);
void bmo_rotate_colors_ex(BMesh *bm, BMOperator *op);
void bmo_rotate_edges_ex(BMesh *bm, BMOperator *op);
