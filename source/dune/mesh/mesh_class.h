...
/* vert */
#define _MESH_GENERIC_TYPE_VERT_NONCONST BMVert *, BMVert_OFlag *
#define _MESH_GENERIC_TYPE_VERT_CONST const BMVert *, const BMVert_OFlag *
#define MESH_CHECK_TYPE_VERT_CONST(ele) CHECK_TYPE_ANY(ele, _BM_GENERIC_TYPE_VERT_CONST)
