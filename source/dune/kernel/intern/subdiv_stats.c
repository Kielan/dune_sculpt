...
void KERNEL_subdiv_stats_init(SubdivStats *stats)
{
...
void KERNEL_subdiv_stats_begin(SubdivStats *stats, eSubdivStatsValue value)
{
  stats->begin_timestamp_[value] = PIL_check_seconds_timer();
}

void KERNEL_subdiv_stats_end(SubdivStats *stats, eSubdivStatsValue value)
{
  stats->values_[value] = PIL_check_seconds_timer() - stats->begin_timestamp_[value];
}

void KERNEL_subdiv_stats_reset(SubdivStats *stats, eSubdivStatsValue value)
{
  stats->values_[value] = 0.0;
}

void KERNEL_subdiv_stats_print(const SubdivStats *stats)
{
