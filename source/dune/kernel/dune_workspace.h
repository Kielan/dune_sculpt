...
struct WorkSpaceLayout *dune_workspace_layout_add(struct Main *main,
                                                 struct WorkSpace *workspace,
                                                 struct Screen *screen,
                                                 const char *name) ATTR_NONNULL();
void dune_workspace_layout_remove(struct Main *main,
                                 struct WorkSpace *workspace,
                                 struct WorkSpaceLayout *layout) ATTR_NONNULL();

void BKE_workspace_relations_free(List *relation_list)

/* -------------------------------------------------------------------- */
/* General Utilities */

struct WorkSpaceLayout *dune_workspace_layout_find(const struct WorkSpace *workspace,
 ...
 */
struct WorkSpaceLayout *dune_workspace_layout_find_global(const struct Main *main,
                                                         const struct Screen *screen,
 ...
 */
struct WorkSpaceLayout *dune_workspace_layout_iter_circular(
...
struct WorkSpace *dune_workspace_active_get(struct WorkSpaceInstanceHook *hook) GETTER_ATTRS;
void dune_workspace_active_set(struct WorkSpaceInstanceHook *hook,
 ...
 * in \a hook). */
struct WorkSpaceLayout *dune_workspace_active_layout_get(const struct WorkSpaceInstanceHook *hook)
    GETTER_ATTRS;
/* Activate a layout
 *
 * Sets layout as active for workspace when activated through or already active in \a hook.
 * So when the active workspace of \a hook is workspace, layout becomes the active layout of
 * hook too. See dune_workspace_active_set().
 *
...
const char *dune_workspace_layout_name_get(const struct WorkSpaceLayout *layout) GETTER_ATTRS;
void dune_workspace_layout_name_set(struct WorkSpace *workspace,
                                   struct WorkSpaceLayout *layout,
                                   const char *new_name) ATTR_NONNULL();
struct Screen *BKE_workspace_layout_screen_get(const struct WorkSpaceLayout *layout) GETTER_ATTRS;
